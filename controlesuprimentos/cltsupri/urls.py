...
urlpatterns = [
    ...
    path('equipamentos/', views.cadastrar_equipamento, name='cadastrar_equipamento'),
    path('equipamentos/<int:equipamento_id>/', views.cadastrar_equipamento, name='cadastrar_equipamento_editar'),
    path('equipamentos/<int:pk>/', views.cadastrar_equipamento, name='editar_equipamento'),
